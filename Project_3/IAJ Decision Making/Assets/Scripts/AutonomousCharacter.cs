...
namespace Assets.Scripts
{
    public class AutonomousCharacter : MonoBehaviour
    {
        ...
        public const float DECISION_MAKING_INTERVAL = 1f;
        ...
        public void Start()
        {
            ...
            this.GainXPGoal = new Goal(GAIN_XP_GOAL, 3.0f)
            {
                ChangeRate = 0.1f
            };
            ...
            {
                InsistenceValue = 0.0f,
                ChangeRate = 0.1f
            };

            this.BeQuickGoal = new Goal(BE_QUICK_GOAL, 30.0f)
            {
                ChangeRate = 0.2f
            };
       ...
       /* public void OnDrawGizmos()
        {
            foreach (NodeRecord n in this.AStarPathFinding.Open.All())
            {
                Gizmos.DrawSphere(n.node.LocalPosition, 1.0f);
            }
        }*/
